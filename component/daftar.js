    ...
    <div class="container-lg">
      ...
      <div class="card border-0 bg--purple rounded--lg overflow-hidden shadow-lg">
        <div class="card-body p-0">
          <form class="form-bg d-flex justify-content-between align-items-center p-5">
            ...
            <button class="btn btn--primary rounded-pill bg-white text--primary text-uppercase pr-2 shadow">
