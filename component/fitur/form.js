...
Vue.component('form-fitur', {
  ...
  <section class="form-kontak">
    <div class="container-lg">
      <div class="h2 font-weight-bold mb-5 text-center text--purple">Cras justo odio</div>
      <div class="row">
              ...
              <div class="card border-0 rounded--lg overflow-hidden">
                <div 
                  ...
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <svg  fill="#7569de" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" focusable="false" width="30px" style="-ms-transform: rotate(90deg); -webkit-transform: rotate(90deg); transform: rotate(90deg);" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
